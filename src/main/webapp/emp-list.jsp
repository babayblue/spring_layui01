...
<div id="empUpdateFormDiv" style="display: none">
    <form class="layui-form" style="margin: 20px 10px" id="empUpdateForm" lay-filter="empUpdateFormFilter">
        <div class="layui-form-item">
            <label class="layui-form-label">编号</label>
            <div class="layui-input-block">
                <input type="text" name="empno" required readonly lay-verify="required" placeholder="请输入编号"
...
<script type="text/javascript">
    layui.use(['table', 'form'], function () {
        ...
        var tabIns = table.render({
            ...
            cols: [[
                {checkbox: true},
                {field: 'empno', title: '员工编号', width: 177, sort: true},
        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(data, function (index, item) {
                    ...
                    $("#deptid2").append(new Option(item.deptname, item.deptid));
                })
                form.render('select');
            }
        })
        ...
        //3.完成数据的增加
        form.on('submit(empForm)', function (data) {//响应提交单表button
